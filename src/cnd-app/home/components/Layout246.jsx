    ...
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28 bg-dark-turquoise/90 text-white relative overflow-hidden">
      ...
      <div className="container relative z-10">
        ...
        <div className="grid grid-cols-1 items-start gap-y-12 md:grid-cols-3 md:gap-x-8 lg:gap-x-12">
          <div>
            <div className="mb-5 md:mb-6">
              <div className="size-12 rounded-full bg-governor-bay/20 flex items-center justify-center">
                <FaUserPlus className="size-6 text-governor-bay" />
              </div>
            </div>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
              <Button iconRight={<RxChevronRight />} variant="link" size="link" className="text-governor-bay hover:text-malachite">
                Sign Up
              </Button>
            </div>
          </div>
          <div>
            <div className="mb-5 md:mb-6">
              <div className="size-12 rounded-full bg-mineral-green/20 flex items-center justify-center">
                <FaMapMarkedAlt className="size-6 text-mineral-green" />
              </div>
            </div>
            <h3 className="mb-3 text-xl font-bold md:mb-4 md:text-2xl text-governor-bay">
          ...
          <div>
            <div className="mb-5 md:mb-6">
              <div className="size-12 rounded-full bg-governor-bay/20 flex items-center justify-center">
                <FaCreditCard className="size-6 text-governor-bay" />
              </div>
            </div>
            <h3 className="mb-3 text-xl font-bold md:mb-4 md:text-2xl text-governor-bay">
            ...
            <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
              <Button iconRight={<RxChevronRight />} variant="link" size="link" className="text-governor-bay hover:text-mineral-green">
                Book Now
              </Button>
            </div>
          </div>
