...
export function Layout239() {
  return (
    <section id="relume" className="px-[5%] py-16 md:py-24 lg:py-28 bg-governor-bay/10 text-black relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 items-start justify-center gap-y-12 md:grid-cols-3 md:gap-x-8 md:gap-y-16 lg:gap-x-12">
            <div className="flex w-full flex-col items-center text-center group">
              <div className="rb-6 mb-6 md:mb-8 overflow-hidden rounded-xl relative">
                ...
                <img
                  src="https://unsplash.com/photos/person-using-smartphone-with-nordic-walking-sticks-lszypRm8AkY"
                  alt="Person using smartphone to locate chargers"
                  className="rounded-xl h-48 w-full object-cover shadow-lg group-hover:scale-105 transition-transform duration-500"
                />
              </div>
              <h3 className="mb-5 text-2xl font-bold md:mb-6 md:text-3xl md:leading-[1.3] lg:text-4xl text-black">
                Easily Locate Chargers in Your Area
              </h3>
              <p className="text-french-gray">Our user-friendly interface makes finding chargers simple.</p>
            </div>
            <div className="flex w-full flex-col items-center text-center group">
              <div className="rb-6 mb-6 md:mb-8 overflow-hidden rounded-xl relative">
                ...
                <img
                  src="https://unsplash.com/photos/woman-looking-at-phone-beside-body-of-water-QofjUnxy9LY"
              ...
              <p className="text-french-gray">Secure your charging spot quickly and effortlessly.</p>
            </div>
            <div className="flex w-full flex-col items-center text-center group">
              <div className="rb-6 mb-6 md:mb-8 overflow-hidden rounded-xl relative">
              ...
              <p className="text-french-gray">Enjoy peace of mind with our secure payment system.</p>
            </div>
          </div>
