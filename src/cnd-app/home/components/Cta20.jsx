        ...
        <div className="w-full max-w-lg">
          ...
          <div className="mt-8 w-full max-w-sm md:mt-10">
            <form className="rb-4 mb-4 grid max-w-sm grid-cols-1 gap-y-3 sm:grid-cols-[1fr_max-content] sm:gap-4">
              ...
              <Button title="Subscribe Now" className="bg-white hover:bg-french-gray text-dark-turquoise font-bold rounded-lg transition-all duration-300 hover:shadow-lg hover:-translate-y-1 btn-pulse">Subscribe Now</Button>
            </form>
