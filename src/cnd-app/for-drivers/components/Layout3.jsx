...
export function Layout3() {
  ...
  return (
    <section className="px-[5%] py-16 md:py-24 lg:py-32 bg-gradient-subtle text-white">
      <div className="container">
        <div className="mb-12 text-center md:mb-16 lg:mb-20">
          <h2 className="text-4xl font-bold md:text-5xl lg:text-6xl">
            Benefits for <span className="text-gradient">Drivers</span>
          </h2>
          <p className="mt-4 text-french-gray">
            Discover why thousands of EV owners choose ChargeNDrive
          </p>
        </div>
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {benefits.map((benefit, index) => (
            <div 
              key={index} 
              className="card-hover flex flex-col items-start rounded-xl bg-white/10 backdrop-blur-sm p-6"
            >
              <div className="mb-4 rounded-full bg-accent p-3 text-mineral-green">
                {benefit.icon}
              </div>
